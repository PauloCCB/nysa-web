  ...
  return (
    <>
      ...
      <section
        ...
        style={{ height: "70vh" }} // Altura controlada para no ocupar toda la pantalla
      >
      ...
      {/* Sección Inversiones Nysa */}
      <section className="py-20 px-6 md:px-20 bg-black bg-opacity-90 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-x-4">
            ...
            <Link
              to="/contactanos"
              className="inline-block bg-transparent border-2 border-white text-white hover:bg-white hover:text-black px-8 py-3 rounded-lg font-semibold transition"
            >
              Contactar
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Con más de 15 años de experiencia en el sector, somos una
                empresa líder en el alquiler de maquinaria pesada y servicios
                especializados para la industria de la construcción y minería.
              </p>
              <p className="text-lg text-gray-700 mb-8">
                Nuestro compromiso es brindar soluciones integrales que permitan
                a nuestros clientes ejecutar sus proyectos de manera eficiente,
                segura y rentable.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">
                    Equipos modernos y certificados
                  </span>
                </div>
            ...
            <div className="relative">
              <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                <video controls className="w-full h-auto" poster="/image1.jpg">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  Ofrecemos una amplia gama de maquinaria pesada para
                  construcción, minería y obras civiles. Equipos modernos y bien
                  mantenidos.
                </p>
                <Link
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  ...
                  para proyectos industriales y comerciales con los más altos
                  estándares.
                </p>
                <Link
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <div className="p-6">
                <p className="text-gray-600 mb-4">
                  Servicios especializados en carpintería para construcción,
                  acabados y proyectos personalizados con materiales de primera
                  calidad.
                </p>
                <Link
